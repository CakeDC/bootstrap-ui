 ...
 */
class DateTimeSelectWidget extends BasicWidget
{
    /**
     * Select box widget.
     *
    ...
    {
        $this->_select = new \Cake\View\Widget\SelectBoxWidget($templates);
    ...
    protected function _renderInput(array $data, ContextInterface $context)
    {
        ...
        foreach ($this->_selects as $select) {
            ...
            $data[$select] = $this->injectClasses('form-control', $data[$select]);
